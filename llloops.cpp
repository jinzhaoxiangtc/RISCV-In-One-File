...
/************************************************************************
 *   Calculate extra loops for running time of 5 seconds per kernel     *
 ************************************************************************/
 ...
 ************************************************************************/
    ...
    for ( section=0 ; section<3 ; section++ )
    {
        fprintf (outfile, "Loops  200 x %2d x Passes\n\n", mul[section]);
        fprintf (outfile, "Kernel       Floating Pt ops\n");
        fprintf (outfile, "No  Passes E No    Total      Secs.  MFLOPS "
                                      "Span     Checksums          OK\n");
        fprintf (outfile, "------------ -- ------------- ----- ------- "
                                       "---- ---------------------- --\n");
        for ( which=1; which<25 ; which++ )
        {
           fprintf (outfile, "%2d %3d x%4d %2d %13.6e %5.2f%8.2f %4d "
                                                      "%22.15e %2d\n",
                   which, xloops[section][which],
                   extra_loops[section][which], xflops[which],
                   FPops[section][which], RunTime[section][which],
                   Mflops[section][which], nspan[section][which],
                   Checksum[section][which], accuracy[section][which]);
        }
        fprintf (outfile, "\n");
        fprintf (outfile, "                     Maximum   Rate%8.2f \n",
                                                      maximum[section]);
        fprintf (outfile, "                     Average   Rate%8.2f \n",
                                                      average[section]);
        fprintf (outfile, "                     Geometric Mean%8.2f \n",
                                                      geometric[section]);
        fprintf (outfile, "                     Harmonic  Mean%8.2f \n",
                                                      harmonic[section]);
        fprintf (outfile, "                     Minimum   Rate%8.2f \n\n",
                                                      minimum[section]);
        fprintf (outfile, "                     Do Span   %4d\n\n",
                                                      xspan[section]);
    }
    fprintf (outfile, "                Overall\n\n");
    fprintf (outfile, "                Part 1 weight 1\n");
    fprintf (outfile, "                Part 2 weight 2\n");
    fprintf (outfile, "                Part 3 weight 1\n\n");
    fprintf (outfile, "                     Maximum   Rate%8.2f \n",
                                                        maximum[3]);
    fprintf (outfile, "                     Average   Rate%8.2f \n",
                                                        average[3]);
    ...
    printf ("you may wish to rename LLLOOPS.TXT with a more informative title.\n\n");
